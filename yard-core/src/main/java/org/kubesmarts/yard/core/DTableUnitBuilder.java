...
import org.kubesmarts.yard.api.model.InlineRule;
import org.kubesmarts.yard.api.model.Rule;
import org.kubesmarts.yard.api.model.WhenThenRule;
import org.kubesmarts.yard.api.model.DecisionTable;
...
public class DTableUnitBuilder {
    ...
    public DTableUnitBuilder(
            ...
            final String name,
            final DecisionTable dtableDefinition) {
